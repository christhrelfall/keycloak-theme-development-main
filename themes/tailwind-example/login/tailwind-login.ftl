...
<@template.loginLayout ; section>
	<#if section = "main">
		...
		<div>
			...
			<#else>
				<div>
					<p class="text-paragraph text-paragraph tracking-paragraph text-black">
			...
			<div class="mt-10">
				<form class="space-y-6" id="kc-form-login" onsubmit="login.disabled = true; return true;" action="${url.loginAction}" method="post">
						...
						<div class="flex items-center justify-between">
							<#if realm.rememberMe>
								<div class="flex items-center">
									<input tabindex="3" id="rememberMe" name="rememberMe" type="checkbox" class="h-4 w-4 text-black focus:ring-black border-black rounded">
					...
					<div>
						...
						<button tabindex="4" type="submit" name="login" id="kc-login" class="w-full flex justify-center py-2 px-4 border-4 uppercase text-button font-semibold text-white bg-blue-700 border-none hover:bg-blue-800">
							${msg("doLogIn")}
						</button>
					</div>
				</form>
